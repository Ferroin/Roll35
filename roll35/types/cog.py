...
class R35Cog(commands.Cog):
    ...
    def __init__(self: R35Cog, /, bot: commands.Bot, dataset: DataSet, renderer: Renderer):
        self.bot = bot
        self.ds = dataset
    ...
    async def cog_before_invoke(self: R35Cog, /, ctx: commands.Context):
    ...
    async def cog_command_error(self: R35Cog, /, ctx: commands.Context, err: commands.CommandError) -> NoReturn:
